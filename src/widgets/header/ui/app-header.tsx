...
export function AppHeader({
  ...
  return (
    <View
      className={cn(
        'relative h-14 flex-row items-center justify-center border-b border-border bg-surface px-4',
        className,
      )}
    >
      {onBackPress && (
        <Pressable
          ...
          className='absolute left-4 h-10 w-10 items-center justify-center rounded-12 active:scale-[0.92]'
          hitSlop={8}
          onPress={onBackPress}
        >
